...
# Get the ranging value of the ultrasonic sensor
@dispatcher.add_method
...
# get the voltage of current battery
@dispatcher.add_method
...
# set the RGB mode of the ultrasonice sensor
@dispatcher.add_method
...
# set RGB light color of ultrasonic sensor
@dispatcher.add_method
...
# set the flashing color and cycle of ultrasonic sensor
@dispatcher.add_method
